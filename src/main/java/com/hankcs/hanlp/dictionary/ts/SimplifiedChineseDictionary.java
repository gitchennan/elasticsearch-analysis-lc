...
public class SimplifiedChineseDictionary extends BaseChineseDictionary
{
    ...
    static
    {
        ...
        {
            throw new IllegalArgumentException("简繁词典" + HanLP.Config.tcDictionaryRoot + "s2t.txt" + "加载失败");
        }

        logger.info("简繁词典" + HanLP.Config.tcDictionaryRoot + "s2t.txt" + "加载成功，耗时" + (System.currentTimeMillis() - start) + "ms");
    }
