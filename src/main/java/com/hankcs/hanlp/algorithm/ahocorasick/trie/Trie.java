...
public class Trie {
    ...
    public Collection<Token> tokenize(String text) {
        ...
        List<Emit> collectedEmits = parseText(text);
        List<Interval> collectedIntervals = new ArrayList<>();
        for (Emit emit : collectedEmits) {
            collectedIntervals.add(emit);
        }


        // 下面是最长分词的关键
        IntervalTree intervalTree = new IntervalTree(collectedIntervals);
        intervalTree.removeOverlaps(collectedIntervals);
        // 移除结束
    ...
    public List<Emit> parseText(String text) {
        ...
        if (!trieConfig.isAllowOverlaps()) {
            IntervalTree intervalTree = new IntervalTree((List<Interval>) (List<?>) collectedEmits);
            intervalTree.removeOverlaps((List<Interval>) (List<?>) collectedEmits);
        }
