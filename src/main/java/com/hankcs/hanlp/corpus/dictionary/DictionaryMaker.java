...
//{
//    BinTrie<Item> doubleArrayTrie;
//
//    public DictionaryMaker() {
//        doubleArrayTrie = new BinTrie<Item>();
//    }
//
//    /**
//     * 向词典中加入一个词语
...
//        return doubleArrayTrie.entrySet();
//    }
//
//    public Set<String> keySet() {
//        return doubleArrayTrie.keySet();
//    }
//
//    /**
//     * 插入条目，但是不合并，如果已有则忽略
...
//        sb.append(doubleArrayTrie.size());
//        return sb.toString();
//    }
////
////    @Override
...
////    {
////        if (doubleArrayTrie.size() == 0) return true;  // 如果没有词条，那也算成功了
////        try
////        {
////            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(IOUtil.newOutputStream(path), "UTF-8"));
////            Set<Map.Entry<String, Item>> entries = doubleArrayTrie.entrySet();
