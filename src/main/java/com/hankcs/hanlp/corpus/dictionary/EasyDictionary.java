...
//
//import com.hankcs.hanlp.collection.doubleArrayTrie.DoubleArrayTrie;
...
//import java.util.*;
//
//import static com.hankcs.hanlp.api.HanLpGlobalSettings.IOAdapter;
//
///**
// * 一个通用的、满足特定格式的双数组词典
// *
...
//    DoubleArrayTrie<WordAttribute> doubleArrayTrie = new DoubleArrayTrie<WordAttribute>();
//
...
//        }
//
//        logger.info("通用词典DAT构建结果:" + doubleArrayTrie.build(wordList, attributeList));
//        logger.info("通用词典加载成功:" + doubleArrayTrie.size() + "个词条");
//        return true;
//    }
//
...
//    }
//
//    public class Searcher extends BaseSearcher<WordAttribute> {
//        /**
//         * 分词从何处开始，这是一个状态
//         */
//        int begin;
//
//        private List<Map.Entry<String, WordAttribute>> entryList;
//
...
//                entryList = doubleArrayTrie.commonPrefixSearchWithValue(c, begin);
//                ++begin;
//            }
//            // 之后调用仅在缓存用完的时候调用一次
...
//     * 通用词典中的词属性
//     */
//    static public class WordAttribute {
//        /**
//         * 词性列表
//         */
