...
public class MDAGNode
{
    ...
    /**
     * 沿着一个路径转移<br>
     * Follows a _transition CUSTOM_DICTIONARY_PATHS starting from this node.
     
     * @param str               a String corresponding a _transition CUSTOM_DICTIONARY_PATHS in the MDAG
     * @return                  the MDAGNode at the end of the _transition CUSTOM_DICTIONARY_PATHS corresponding to
     *                          {@code str}, or null if such a _transition CUSTOM_DICTIONARY_PATHS is not present in the MDAG
     */
    ...
    /**
     * 获取一个字符串路径上经过的节点<br>
     * Retrieves the nodes in the _transition CUSTOM_DICTIONARY_PATHS starting
     * from this node corresponding to a given String .
     
     * @param str       a String corresponding to a _transition CUSTOM_DICTIONARY_PATHS starting from this node
     * @return          a Stack of MDAGNodes containing the nodes in the _transition CUSTOM_DICTIONARY_PATHS
