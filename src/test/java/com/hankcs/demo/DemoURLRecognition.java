...
public class DemoURLRecognition {
    public static void main(String[] args) {
        String text =
                "HanLP的项目地址是https://github.com/com.hankcs/HanLP，" +
                        "发布地址是https://github.com/com.hankcs/HanLP/releases，" +
                        "我有时候会在www.com.hankcs.com上面发布一些消息，" +
                        "我的微博是http://weibo.com/com.hankcs/，会同步推送hankcs.com的新闻。" +
